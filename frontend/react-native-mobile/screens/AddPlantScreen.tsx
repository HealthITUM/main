...
export const AddPlantScreen = ({ navigation }: any) => {
    ...
    const validate = () => {
        ...
        const resolvedSpecieId = speciesMode === "detect" ? detectedSpecieId : selectedSpecieId;
        if (!resolvedSpecieId) {
            ...
            <ScrollView contentContainerStyle={{ padding: 20 }}>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Text style={{ color: "white", fontWeight: "600" }}>Select manually</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            style={{
                                flex: 1,
                        ...
                        >
                            <Text style={{ color: "white", fontWeight: "600" }}>Detect from image</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    {speciesMode === "detect" && (
                        <View style={{ marginBottom: 10 }}>
                            <View style={{ flexDirection: "row", gap: 10, marginBottom: 10 }}>
                                ...
                                >
                                    <Text style={styles.darkGreenButtonText}>Choose Detection Image</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    style={[styles.darkGreenButton, { flex: 1, justifyContent: "center", alignItems: "center" }]}
                                    onPress={takeDetectPhoto}
                                >
                                    <Text style={styles.darkGreenButtonText}>Take Detection Photo</Text>
                                </TouchableOpacity>
                            </View>
                            ...
                            <TouchableOpacity
                                style={[
                                    ...
                                    { justifyContent: "center", alignItems: "center", opacity: detecting || !detectImage ? 0.6 : 1 },
                                ]}
                            ...
                            >
                                {detecting ? (
                                    <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
                                        ...
                                        <Text style={styles.darkGreenButtonText}>Detecting...</Text>
                                    </View>
                                ) : (
                                    <Text style={styles.darkGreenButtonText}>Detect Species</Text>
                                )}
                            </TouchableOpacity>

                            {detectedSpecieId && !detecting && (
                                <View style={{ marginTop: 10, padding: 12, backgroundColor: "#4B6043", borderRadius: 8 }}>
                            ...
                            {detectionFailed && !detecting && (
                                <View style={{ marginTop: 10, padding: 12, backgroundColor: "#7a2e2e", borderRadius: 8 }}>
                                    <Text style={{ color: "white" }}>
