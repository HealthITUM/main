    ...
    <SafeAreaView style={styles.appContainer}>
      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 80 }}>
        ...
        <View style={styles.darkGreenCard}>
          ...
          <Text style={[styles.baseText, { fontSize: 15 }]}>{plant.id}</Text>

          <TouchableOpacity
            style={[styles.darkGreenButton, { marginTop: 15 }]}
            onPress={() => navigation.navigate("EditPlant", { id: plant.id })}
          >
            <Text style={styles.darkGreenButtonText}>Edit plant</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={[styles.darkGreenCard, { marginTop: 15 }]}>
          ...
          >
            ...
            >
              <Text style={styles.darkGreenButtonText}>+ Add Sensor</Text>
            </TouchableOpacity>
          </View>

          {sensors.length === 0 ? (
            <Text style={styles.baseText}>No sensors connected</Text>
          ) : (
            sensors.map((sensor) => (
              <View
                key={sensor.id}
              ...
              >
                ...
                >
                  <Text style={styles.darkGreenButtonText}>Delete sensor</Text>
                </TouchableOpacity>
              </View>
            ))
          )}
